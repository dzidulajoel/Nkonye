                        ...
                        {isOpen && (
                                ...
                                >
                                        ...
                                        <div className="flex justify-between items-center mb-4">
                                                <h2 className="text-[18px] font-bold leading-[24px] text-[#374957] font-body">Commentaires</h2>
                                                ...
                                                <div className="p-3 rounded-md bg-white w-full flex flex-col justify-center items-center gap-2">
                                                        <span className="w-10 h-10 rounded-md flex  justify-center items-center" style={{backgroundColor:colors.primary.DEFAULT}}><MessageCircle size={20} color="#fff" /></span>
                                                        <p className="text-sm font-body">Pas de commentaire pour l'instant.</p>
                                                </div>
                                </motion.div>
                        )}
                </AnimatePresence>
